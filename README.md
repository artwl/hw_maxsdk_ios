...
本文档是IOS版变现SDK，当前版本 `V7.7.0`

## 下载地址

SDK 下载地址：[v7.7.0](https://github.com/artwl/hwsdk_ios/releases/tag/V7.7.0)
...
接入请参考：[SDK接入文档](https://github.com/artwl/hwsdk_ios/wiki/HwSDK-V7.6%E6%8E%A5%E5%85%A5%E6%96%87%E6%A1%A3%EF%BC%88%E9%80%82%E7%94%A8%E4%BA%8E7.6.0%EF%BD%9E7.7.0%EF%BC%89)
...
- **7.7.1 新特性（2021年3月4号）（内测中外部项目先不接入。。。）**
 - 1.更新Facebook至6.2.1
 - 2.添加Google的开屏广告
- **7.7.0 新特性（2021年2月2号）**
