...
本文档是iOS版变现SDK，当前版本 `V9.8.75`

## 下载地址

SDK 下载地址：[v9.8.75](https://github.com/artwl/hw_maxsdk_ios/releases/tag/V9.8.75)
...
- **9.8.75 新特性（2026年8月3号）**
  - 1.优化SDK内部逻辑
  - 2.更新第三方库
  
- **9.8.66 新特性（2026年5月20号）**
  - 1.优化SDK内部逻辑
  - 2.更新第三方库
  
- **9.8.50 新特性（2026年1月28号）**
  - 1.优化SDK内部逻辑
  - 2.更新第三方库
  
- **9.8.33 新特性（2025年12月16号）**
  - 1.优化SDK内部逻辑

- **9.8.32 新特性（2025年11月17号）**
  - 1.优化SDK内部逻辑

- **9.8.30 新特性（2025年11月4号）**
  - 1.优化SDK内部逻辑
  
- **9.8.28 新特性（2025年10月29号）**
  - 1.更新第三方库版本
